...
if auto == 1:
    ...
    print("[+] This program was created by @Garcia09. [github.com/secret]")
    print("[+] This program was origionally uploaded to github.com/secret/tiktodv3.")
    print("[+] This program was majorly improved by @Garcia09. [github.com/XxB1a]")
